...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
    ...
    const inactivityDuration = 3 * 60 * 60 * 1000;
    const inactivityTimeoutIdRef = useRef<ReturnType<typeof setTimeout> | null>(null);
    ...
    return (
        <AuthContext.Provider value={{ auth, setAuth, resetInactivityTimer, loading }}>
            {children}
        </AuthContext.Provider>
    );
};
